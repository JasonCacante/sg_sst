...
class Empleado(models.Model):
    ...
    estudios = models.CharField(
        max_length=25, choices=niveles, verbose_name="Nivel de estudio"
    )
    ...
    genero = models.CharField(
        max_length=1, choices=gender, verbose_name="Sexo biológico"
    )
    sangre = [
        ("O+", "O+"),
        ("O-", "O-"),
    ...
    induccion = models.BooleanField(
        blank=True, null=True, verbose_name="¿Recibió la inducción de SST?"
    )
    ...
    vacuna = models.BooleanField(
        blank=True, null=True, verbose_name="¿Tiene esquema de vacunación?"
    )
    carne = models.FileField(
        upload_to="carnet", verbose_name="Carnet", blank=True, null=True
    )
...
class Seguridad_Social(models.Model):
    ...
    ccf = models.CharField(
        max_length=20, default="Comfenalco", verbose_name="Caja de compensación"
    )
    arl = models.CharField(
        max_length=20,
        default="Bolivar",
        verbose_name="Aseguradora de Riesgos Laborales",
    )
