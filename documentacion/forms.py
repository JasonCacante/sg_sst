    ...
    class Meta:
        ...
        widgets = {
            ...
            "tipo_doc": forms.Select(
                attrs={"class": "form-select form-select-lg mb-3", "id": "name"}
            ),
            ...
            "observaciones": forms.Textarea(
                attrs={
                    ...
                    "widht": "50%",
                    "height": "30%",
                    "placeholder": "Escriba las observaciones del documento",
                }
            ),
        ...
        widgets = {
            ...
            "descripcion": forms.Textarea(
                attrs={
                    ...
                    "widht": "50%",
                    "height": "20%",
                    "placeholder": "Escriba una descripción del documento",
                }
            ),
            "documento": forms.FileInput(
                attrs={
